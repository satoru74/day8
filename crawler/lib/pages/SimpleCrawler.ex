defmodule SimpleCrawler do
  ...
  def run do
     ...
     result
     Pages.Repo.start_link()
     insert_data(result)
     save_csv(result,"pages")
     end

   def insert_data(result) do
    for i <- 0..(length(result) - 1) do
      changeset = Map.merge(%Pages.Page{}, Enum.at(result, i))
      Pages.Repo.insert(changeset)
     end
